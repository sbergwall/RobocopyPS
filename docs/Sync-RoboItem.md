...
```
Sync-RoboItem [-WhatIf] [-Confirm] [-Source] <String> [-Destination] <String> [-Force]
 [-ClearLastExitCodeOnSuccess] [[-Level] <Int32>] [-RestartMode] [-BackupMode] [-RestartAndBackupMode]
 [-UnbufferedIO] [-EFSRaw] [[-CopyFlags] <String[]>] [[-DirectoryCopyFlags] <String[]>] [-CopyWithSecurity]
 [-CopyAllFileInformation] [-NoCopy] [-SecurityFix] [-Timefix] [[-AddAttribute] <String[]>]
